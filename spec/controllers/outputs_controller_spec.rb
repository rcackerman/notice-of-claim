...
RSpec.describe OutputsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all outputs as @outputs" do
      ...
      expect(assigns(:outputs)).to eq([output])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested output as @output" do
      ...
      expect(assigns(:output)).to eq(output)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new output as @output" do
      ...
      expect(assigns(:output)).to be_a_new(Output)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created output as @output" do
        post :create, {:output => valid_attributes}, valid_session
        expect(assigns(:output)).to be_a(Output)
        expect(assigns(:output)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved output as @output" do
        post :create, {:output => invalid_attributes}, valid_session
        expect(assigns(:output)).to be_a_new(Output)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested output" do
        output = Output.create! valid_attributes
        put :update, {:id => output.to_param, :output => new_attributes}, valid_session
        output.reload
    ...
    context "with invalid params" do
      it "assigns the output as @output" do
        output = Output.create! valid_attributes
        put :update, {:id => output.to_param, :output => invalid_attributes}, valid_session
        expect(assigns(:output)).to eq(output)
      end
